# C-en draft: summer crops stardew

Role: Agent C-en (writing only). Not D’s three gates. Not Title / H1 / Description / slug. Not `src/` or `public/` assembly.  
Keyword: summer crops stardew. locale=en, country=US.  
Inputs: `A-en-research.md` (research date 2026-09-13), `B-en-layout.md`. D-en check: 10 must-fix items.

---

## 1. Working H2/H3 + body

There is no single best outdoor summer crop. [Starfruit](https://stardewvalleywiki.com/Starfruit) sits at the top of the wiki gold/day table only after you can reach [Oasis](https://stardewvalleywiki.com/Oasis) and pay [400g](https://stardewvalleywiki.com/Starfruit_Seeds) a seed; Year 1 at [Pierre’s](https://stardewvalleywiki.com/Pierre%27s_General_Store) is a tile choice among [blueberry](https://stardewvalleywiki.com/Blueberry), [melon](https://stardewvalleywiki.com/Melon), and [hops](https://stardewvalleywiki.com/Hops); Year 2 puts [Red Cabbage](https://stardewvalleywiki.com/Red_Cabbage) on that same table at about 17.78g/day. Rank by the shop you can open this morning, then by the [Crops](https://stardewvalleywiki.com/Crops) gold/day figure, then by how many tiles you can water and whether that soil is still planted when you wanted the next crop.
...
Do not assemble this appendix into `src/`.

### Figure slots

| ID | Type | Body location | Working file | Caption (matches reader-facing italic in section 1) |
|---|---|---|---|---|
| Fig 1 | Controlled Summer 1–28 calendar schematic. Not a screenshot. | After the derived last-plant table in H2-2 | `public/blog/illustrations/summer-crop-occupancy-calendar.webp` | Summer 1–28 occupancy on one tile, planted on Summer 1, watered every day, with no Speed-Gro. Blueberry picks land on 14, 18, 22, and 26, so the tile is still planted on the mornings you might have wanted a second melon. Hops first pick is day 12, then daily through 28 (17 picks). Melon needs 12 growing days; the derived last plant for a Summer 28 harvest is 16. Starfruit needs 13 growing days; the derived last plant is 15. Last-plant dates are derived as 28 minus grow days, not a wiki field name. Read which mornings the tile is still occupied before you buy the next seed. |
| Fig 2 | Controlled tile grid of hops row + walk tile, melon 3-by-3, blueberry rectangle. Not a screenshot. | H2-6 | `public/blog/illustrations/summer-hops-melon-blueberry-bed.webp` | Occupancy on one bed, not a 1% giant already rolled. North (or one side): a hops row plus at least one walking tile. One melon 3-by-3 with the top-left cell marked, all nine melon, no sprinkler or scarecrow inside the square. A blueberry rectangle that does not overlap those nine tiles and does not sit behind a hops wall. A hops ring around the melon is the failed layout: you cannot walk through living hops to water the top-left or to chop a giant. This grid uses the wiki trellis and giant rules. |

Cover is out of C’s assembly scope. B’s cover brief (for G): outdoor summer field with readable blueberry rows, a melon block, and hops trellis; not a greenhouse; not a Community Center board; not a fake screenshot.

### PublicReference list

Verification date 2026-09-13. Only URLs Agent A opened. `occurrence` is 1-based inside section 1 (working H2/H3 + body). Quotes are exact body fragments.

| id | label | url | appliesTo (quote) | occurrence |
|---|---|---|---|---|
| wiki-summer | Stardew Valley Wiki: Summer | https://stardewvalleywiki.com/Summer | Spring-only plants [wilt on Summer 1](https://stardewvalleywiki.com/Summer). | 1 |
| wiki-summer-table | Stardew Valley Wiki: Summer (crop tables) | https://stardewvalleywiki.com/Summer | The [Summer](https://stardewvalleywiki.com/Summer) crop tables and the matching crop pages supply the numbers. | 1 |
| wiki-summer-wilt-fall | Stardew Valley Wiki: Summer (season-change wilt) | https://stardewvalleywiki.com/Summer | [wilts on Fall 1](https://stardewvalleywiki.com/Summer) the same way spring-only crops wilt on Summer 1. | 1 |
| wiki-crops-gold | Stardew Valley Wiki: Crops (gold per day) | https://stardewvalleywiki.com/Crops | The formula is `((Max Harvests × Sell Price per Harvest) − Seed Price) / Growing Days`, with `Growing Days = Days to Maturity + ((Max Harvests − 1) × Days to Regrow)`. | 1 |
| wiki-crops-assumptions | Stardew Valley Wiki: Crops (gold/day assumptions) | https://stardewvalleywiki.com/Crops | The published figures assume no fertilizer, no crop quality, no Tiller, and no Agriculturist. | 1 |
| wiki-crops-giant | Stardew Valley Wiki: Crops (giant crops) | https://stardewvalleywiki.com/Crops | Each morning, every overlapping 3-by-3 grid has a 1% chance to combine if the top-left plant is fully grown and watered and all nine plants are the same type. | 1 |
| wiki-pierre-summer | Stardew Valley Wiki: Pierre's General Store (Summer Stock) | https://stardewvalleywiki.com/Pierre%27s_General_Store | Year 1 Summer 1 is a Pierre morning. | 1 |
| wiki-pierre-hours | Stardew Valley Wiki: Pierre's General Store (hours) | https://stardewvalleywiki.com/Pierre%27s_General_Store | The [summer counter](https://stardewvalleywiki.com/Pierre%27s_General_Store) runs 9am–5pm; you can enter the shop until 9pm. | 1 |
| wiki-pierre-speedgro | Stardew Valley Wiki: Pierre's General Store (Speed-Gro) | https://stardewvalleywiki.com/Pierre%27s_General_Store | Pierre sells Speed-Gro from Spring 15 of year 1 at 100g | 1 |
| wiki-starfruit | Stardew Valley Wiki: Starfruit | https://stardewvalleywiki.com/Starfruit | Sell prices are 750g, 937g, 1125g, and 1500g by quality. | 1 |
| wiki-starfruit-goldday | Stardew Valley Wiki: Starfruit / Summer gold/day | https://stardewvalleywiki.com/Starfruit | Starfruit’s wiki gold/day of about 26.92g is one 13-day cycle: (750g − 400g) / 13. | 1 |
| wiki-starfruit-luau | Stardew Valley Wiki: Starfruit (Luau) | https://stardewvalleywiki.com/Starfruit | The Luau sells one starfruit per year for 3,000g. | 1 |
| wiki-starfruit-seeds | Stardew Valley Wiki: Starfruit Seeds | https://stardewvalleywiki.com/Starfruit_Seeds | [Starfruit Seeds](https://stardewvalleywiki.com/Starfruit_Seeds) cost **400g** there. | 1 |
| wiki-starfruit-seed-routes | Stardew Valley Wiki: Starfruit Seeds (other sources) | https://stardewvalleywiki.com/Starfruit_Seeds | The Traveling Cart sells them for 600g–1,000g. Gunther gives one seed after 15 museum donations. A Seed Maker can produce more. Skull Cavern treasure chests can drop 5–20 seeds. | 1 |
| wiki-oasis-hours | Stardew Valley Wiki: Oasis | https://stardewvalleywiki.com/Oasis | Sandy’s shop in the [Calico Desert](https://stardewvalleywiki.com/The_Desert) is open 9am–11:50pm. | 1 |
| wiki-desert-lock | Stardew Valley Wiki: The Desert | https://stardewvalleywiki.com/The_Desert | The desert stays locked until the bus is repaired | 1 |
| wiki-bus-ticket | Stardew Valley Wiki: Bus Stop | https://stardewvalleywiki.com/Bus_Stop | A [bus ticket](https://stardewvalleywiki.com/Bus_Stop) is 500g, and Pam drives 10am–5pm. | 1 |
| wiki-vault | Stardew Valley Wiki: Bundles (Vault) | https://stardewvalleywiki.com/Bundles | complete the four [Vault](https://stardewvalleywiki.com/Bundles) gold bundles for 42,500g (2,500g + 5,000g + 10,000g + 25,000g), or pay Joja’s Bus Repair for 40,000g. | 1 |
| wiki-blueberry | Stardew Valley Wiki: Blueberry | https://stardewvalleywiki.com/Blueberry | Sell prices are 50g, 62g, 75g, and 100g by quality. Fertilizer quality applies to the first berry only. | 1 |
| wiki-blueberry-calendar | Stardew Valley Wiki: Blueberry / Summer max harvests | https://stardewvalleywiki.com/Blueberry | Plant on Summer 1, water every day, use no Speed-Gro, and the picks are Summer 14, 18, 22, and 26. | 1 |
| wiki-blueberry-goldday | Stardew Valley Wiki: Summer (blueberry gold/day) | https://stardewvalleywiki.com/Summer | Blueberry’s 20.8g uses three 50g berries per harvest: growing days are 13 + (4 − 1) × 4 = 25, and ((4 × 150g) − 80g) / 25 = 20.8g. | 1 |
| wiki-melon | Stardew Valley Wiki: Melon | https://stardewvalleywiki.com/Melon | Sell prices are 250g, 312g, 375g, and 500g by quality. | 1 |
| wiki-melon-goldday | Stardew Valley Wiki: Melon / Summer gold/day | https://stardewvalleywiki.com/Melon | Wiki gold/day is about 14.17g: (250g − 80g) / 12. | 1 |
| wiki-melon-giant-drop | Stardew Valley Wiki: Crops (giant drop) | https://stardewvalleywiki.com/Crops | A giant takes three axe hits and drops 15 to 21 regular-quality melons. It cannot form in the greenhouse, in garden pots, or on Ginger Island. | 1 |
| wiki-hops | Stardew Valley Wiki: Hops | https://stardewvalleywiki.com/Hops | You cannot walk through hops at any living stage. | 1 |
| wiki-hops-goldday | Stardew Valley Wiki: Hops / Summer gold/day | https://stardewvalleywiki.com/Hops | Wiki gold/day is about 13.52g, which is below blueberry’s 20.8g on the same table. | 1 |
| wiki-hops-calendar | Stardew Valley Wiki: Hops (17 harvests) | https://stardewvalleywiki.com/Hops | Planted on Summer 1, the first pick is day 12, then every day through 28, which is 17 picks and matches the wiki maximum. | 1 |
| wiki-hops-pale-ale | Stardew Valley Wiki: Hops (Pale Ale artisan price) | https://stardewvalleywiki.com/Hops | The hops infobox lists artisan base 300g (420g with Artisan). | 1 |
| wiki-red-cabbage | Stardew Valley Wiki: Red Cabbage | https://stardewvalleywiki.com/Red_Cabbage | Pierre sells the seed for 100g from year 2. | 1 |
| wiki-red-cabbage-goldday | Stardew Valley Wiki: Red Cabbage / Summer gold/day | https://stardewvalleywiki.com/Red_Cabbage | Wiki gold/day is about 17.78g, between blueberry’s 20.8g and melon’s about 14.17g on the same table. | 1 |
| wiki-red-cabbage-year1 | Stardew Valley Wiki: Red Cabbage (Year 1 bypass) | https://stardewvalleywiki.com/Red_Cabbage | Not a Year 1 Pierre default. Year 1 only from the Traveling Cart or Skull Cavern. | 1 |
| wiki-corn | Stardew Valley Wiki: Corn | https://stardewvalleywiki.com/Corn | A plant placed on Summer 28 continues on Fall 1 and keeps fertilizer under the tile. | 1 |
| wiki-corn-goldday | Stardew Valley Wiki: Corn / Summer gold/day | https://stardewvalleywiki.com/Corn | Summer-only wiki gold/day is about 1.92g. Across summer and fall it is about 7.41g | 1 |
| wiki-tomato | Stardew Valley Wiki: Tomato | https://stardewvalleywiki.com/Tomato | tomato’s extra 5% | 1 |
| wiki-hot-pepper | Stardew Valley Wiki: Hot Pepper | https://stardewvalleywiki.com/Hot_Pepper | hot pepper’s extra 3% | 1 |
| wiki-radish | Stardew Valley Wiki: Radish | https://stardewvalleywiki.com/Radish | Radish turns tiles over every 6 days and still lands at about 8.33g. | 1 |
| wiki-wheat | Stardew Valley Wiki: Wheat | https://stardewvalleywiki.com/Wheat | Wheat at 3.75g is a 10g seed and a scythe crop, not a summer rank winner. | 1 |
| wiki-poppy | Stardew Valley Wiki: Poppy | https://stardewvalleywiki.com/Poppy | bee-house poppy honey sells for 380g against 100g for regular honey | 1 |
| wiki-sunflower | Stardew Valley Wiki: Sunflower | https://stardewvalleywiki.com/Sunflower | Wiki gold/day is −15g because the seed costs 200g and the flower sells for 80g. | 1 |
| wiki-squash | Stardew Valley Wiki: Summer Squash | https://stardewvalleywiki.com/Summer_Squash | [Summer squash](https://stardewvalleywiki.com/Summer_Squash) shows about 13.33g, next to hops at about 13.52g, because the formula seed price is 0g. | 1 |
| wiki-squash-seeds | Stardew Valley Wiki: Summer Squash Seeds | https://stardewvalleywiki.com/Summer_Squash_Seeds | The seeds are not sold for gold at Pierre, Joja, or the Traveling Cart. | 1 |
| wiki-coffee | Stardew Valley Wiki: Coffee Bean | https://stardewvalleywiki.com/Coffee_Bean | The Traveling Cart’s 2,500g special appears 25% of the time in fall and winter; the cart’s 100g–1,000g range is a different listing that can appear in all seasons. | 1 |
| wiki-coffee-dust | Stardew Valley Wiki: Coffee Bean (Dust Sprite) | https://stardewvalleywiki.com/Coffee_Bean | Dust Sprites drop it at 1%. | 1 |
| wiki-ancient-fruit | Stardew Valley Wiki: Ancient Fruit | https://stardewvalleywiki.com/Ancient_Fruit | Planted on Summer 1, the first harvest is day 1 of the next season, not a summer shipping-box crop. | 1 |
| wiki-ancient-seeds | Stardew Valley Wiki: Ancient Seeds | https://stardewvalleywiki.com/Ancient_Seeds | [Ancient Seeds](https://stardewvalleywiki.com/Ancient_Seeds) are not sold at Pierre, Joja, or the cart. | 1 |
| site-planner | Stardew Valley Planner (homepage) | https://stardewvalleyplanner.art/ | The tool can place crops on the eight farm maps plus Ginger Island and can show sprinkler and scarecrow coverage; projects stay in the browser. | 1 |
| site-planner-limits | Stardew Valley Planner (does not compute gold/day) | https://stardewvalleyplanner.art/ | It does not compute gold/day, last-plant dates, or giant 1% rolls. | 1 |

Internal links in the body (not PublicReference wiki rows): `/best-spring-crop-stardew`, `/how-to-earn-money-stardew`, `/glasshouse-stardew-valley`, `/sprinkler-stardew`, `/#planner`.

Derived last-plant dates (Wheat 24, Radish 22, Poppy 21, Sunflower 20, Red Cabbage 19, Melon 16, Starfruit 15) are arithmetic on wiki grow days: `28 − grow days` for a Summer 28 harvest, plant day excluded, no Speed-Gro, plant day watered. The wiki does not name “last plant day.”

### Changelog (D must-fix)

- RT-1: Opening keeps the 28-day outdoor job and the spring-guide link. Deleted “not a greenhouse bed and not a list of every seed the season menu can display.”
- RT-2: Wet-tile plant-count kept. Link to `/how-to-earn-money-stardew` kept as “the same wet-tile rule as in…”. Deleted “belong in … not in this ranking.”
- RT-3: Deleted both “Figure N slot (controlled… not a screenshot…)” lines from the reader body. Italic captions remain.
- RT-4: Removed both `public/blog/illustrations/…` assembly-path sentences from the reader body. Paths live only in this appendix.
- RT-5: Deleted “It is not a claim that the planner blocks walking through hops.” from the Figure 2 caption. Kept occupancy reading and “This grid uses the wiki trellis and giant rules.” Planner T1 limit stays in the optional H2-6 sentence.
- RP-1: Deleted the 11-price Pierre catalog from H2-1. Hours and Starfruit / Red Cabbage gates remain. Prices stay on the H2-2 table.
- RP-2: Gold/day method (formula, assumptions, extras, one-cycle vs season-total) stays in H2-1 only. Table notes now only the blueberry 20.8g worked example. H2-4 Starfruit states ~26.92g as the top cell without (750−400)/13. H2-5 no longer repeats extra 3%/5%. H2-3 still has the blueberry 2% “do not inflate to beat melon” line. Squash “not sold for gold” stays in the table Access cell.
- RP-3: Last-plant roster stays in the H2-2 table plus the wilt-on-Fall-1 rule. H2-5 now points at that table and keeps the late-packet shop warning; it does not re-list 16 / 15 / 19 / 21 / 22.
- RP-4: H2-1 is “Pierre sells Red Cabbage from year 2.” Table Access keeps the cart/Skull bypass. H2-4 uses 9 days / ~17.78g / three empty-tile cycles vs blueberry occupancy, plus Dye Bundle as one appositive; cart/Skull not reprinted there.
- RP-5: H2-2 keeps the blueberry/hops count rule (plant day plus 13 then every 4; plus 11 then daily). Deleted the Summer 1 14/18/22/26 and 17-pick restatement in that paragraph. Those dates remain in the gold/day table Access cells, the Figure 1 caption, and H2-3 occupancy.

Also while editing H2-6 for RT-3/RT-4: merged former steps 5–6 into one line that points at the melon giant-square rules (D residual 4, not a must-fix).

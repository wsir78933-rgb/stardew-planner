...
export const referenceRoutes: readonly ReferenceRoute[] = [
  ...
  },
  {
    ...
    viewport: ["desktop", "mobile"],
    acceptancePurpose:
      "Compare farm map characteristics in the responsive public information layout.",
    states: [
      {
        id: "desktop-comparison-idle",
        action: "Open the farm comparison page.",
        expectedVisibleResult:
          "The desktop farm comparison content and planner navigation are visible.",
        viewport: "desktop",
        toolMode: null,
        selectedEntity: null,
        modalState: null,
      ...
      {
        id: "mobile-comparison-idle",
        action: "Open the farm comparison page.",
        expectedVisibleResult:
          "The mobile farm comparison content and planner navigation are visible.",
        viewport: "mobile",
        toolMode: null,
        selectedEntity: null,
        modalState: null,
  ...
  },
  {
    ...
    viewport: ["desktop", "mobile"],
    acceptancePurpose:
      "Present every official farm guide using the fixed route template.",
    states: [
      {
        id: "desktop-guide-idle",
        action: "Open an official farm guide route.",
        expectedVisibleResult:
          "The selected farm's guide content and planner navigation are visible on desktop.",
        viewport: "desktop",
        toolMode: null,
        selectedEntity: null,
        modalState: null,
      ...
      {
        id: "mobile-guide-idle",
        action: "Open an official farm guide route.",
        expectedVisibleResult:
          "The selected farm's guide content and planner navigation are visible on mobile.",
        viewport: "mobile",
        toolMode: null,
        selectedEntity: null,
        modalState: null,
  ...
  },
  {
    ...
    viewport: ["desktop", "mobile"],
    acceptancePurpose:
      "Present the responsive Mod-map information and planner entry points.",
    states: [
      {
        id: "desktop-mods-idle",
        action: "Open the Mods page.",
        expectedVisibleResult:
          "Supported Mod maps and their planner entry points are visible on desktop.",
        viewport: "desktop",
        toolMode: null,
        selectedEntity: null,
        modalState: null,
      },
      {
        ...
        action: "Open the Mods page.",
        expectedVisibleResult:
          "Supported Mod maps and their planner entry points are visible on mobile.",
        viewport: "mobile",
        toolMode: null,
        selectedEntity: null,
        modalState: null,

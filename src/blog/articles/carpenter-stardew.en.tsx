...
export function CarpenterStardewEnglishArticle() {
  return (
    <article>
      ...
      <h2>Check the shop before you leave the farm</h2>
      <p>
        Start with the counter, not the front door. Robin&apos;s house is accessible from
        9:00 AM to 8:00 PM even when the shop is closed. Being able to walk inside does
        not mean she can sell, build, or start an upgrade.
      </p>
      <ol>
        <li>
          <strong>Look at the time.</strong> A normal trip belongs between 9:00 AM and
          5:00 PM. On Friday, treat 4:00 PM as the cutoff.
        </li>
        <li>
        ...
        <li>
          ...
          building at your farm, the shop is closed for that workday.
        </li>
        <li>
      ...
      <p>
        The Telephone is useful after you buy it: calling Robin can check the Carpenter&apos;s
        Shop hours and stock from home. It does not replace the construction menu for
        current requirements, but it can save a walk on an uncertain day.
      </p>
      ...
      <p>
        The game gives a simple rule: every placement tile must be green. The planning
        work is deciding whether that clear rectangle will still work after animals,
        machines, fences, grass, and daily traffic arrive.
      </p>
      <h3>Start with the door</h3>
      <p>
        Pick the entrance side first. A coop door facing a narrow fence gap, or a shed
        door opening into a crop lane, makes a technically valid placement irritating
        every day. Leave a route for the player, the horse when relevant, and the work
        you expect around the building.
      </p>
      <p>
        Then leave room for the next decision. A small animal area needs grass and gates;
        a shed needs machine access; an upgraded building can need a larger working zone
        even when its own footprint is valid.
      </p>
      <p>
        Open the{" "}
      ...
      <figure className="blog-article-media">
        <img
          alt="Farm layout showing a building footprint, entrance, gate, grass, and clear path"
          decoding="async"
          height="941"
          loading="lazy"
        ...
        />
        <figcaption>
          Check the building door, gate, grass, and everyday route together before the
          building becomes part of the farm.
        </figcaption>
      </figure>
      ...
      <p>
        ...
        <a className="blog-planner-link" href="/?farmType=meadowlands">
          Meadowlands map in the planner
        </a>{" "}
        first. It is faster to change a sketch than to rebuild a mature farm one route at a
        time.
      </p>
      ...
      <figure className="blog-article-media">
        <img
          alt="Farm building moved from a cramped path to a clear planned area"
          decoding="async"
          height="941"
          loading="lazy"
        ...
        />
        <figcaption>
          The building contents come with it. The new footprint and route still need a
          proper check.
        </figcaption>
      </figure>
